...
<svg width="120" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 455.431 455.431" style="enable-background:new 0 0 455.431 455.431;" xml:space="preserve">
<path style="fill:#00A4E4;" d="M405.493,412.764c-69.689,56.889-287.289,56.889-355.556,0c-69.689-56.889-62.578-300.089,0-364.089
...
<path style="fill:#FFFFFF;" d="M195.004,354.453c-9.956,0-19.911-4.267-25.6-12.8l-79.644-102.4
  ...
  <div class="text-center p-4">
    <div class="pr-4 text-base text-semibold">All Done!</div>
    <div class="text-gray-500 leading-tight text-xs font-normal">That was sent to Nomie,<br/> you can now close this window</div>
  </div>
</div>
