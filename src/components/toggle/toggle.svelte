...
<div class="onoffswitch {className}">
  <Switch class="onoffswitch {value ? 'on' : 'off dark:bg-gray-700'}" checked={value} on:change={methods.onChange}>
...
<style lang="postcss" global>
  .onoffswitch button {
    ...
    @apply inline-flex;
    @apply  ring-green-500 ring-inset;
  }
  .onoffswitch button:focus {
